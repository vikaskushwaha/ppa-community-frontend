        ...
        <div className="flex rounded-[1.25rem] p-6 bg-[#292C33] ">
            <div className="flex flex-col gap-y-3 w-full">
                <div className="flex  w-[28.125rem] justify-center">
                    <div className="flex  flex-row rouded-[0.75rem] p-2 gap-x-5 bg-[#14171F] max-w-[19.75rem]">
                        <div className=" flex py-2 px-4 w-[8.75rem]  rounded-[0.375rem] bg-[#292C33] justify-center ">
                ...
                <div>
                    <div className="flex flex-col gap-3">
                        <form className=" flex flex-col gap-3">
                            ...
                            <Button className="bg-[#3940A0] py-3 px-2 rounded-[0.625rem] text-white text-[1rem] leading-6 tracking-wide font-gilroybold flex justify-center gap-2 "
                                imageUrl={rockect}
                                altText="rocket"
                            >
                                Join the Challenge
